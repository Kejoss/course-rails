...
ActiveRecord::Schema[7.0].define(version: 2024_05_23_072643) do
  ...
  create_table "answes", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "survey_id"
    t.index ["question_id"], name: "index_answes_on_question_id"
    t.index ["survey_id"], name: "index_answes_on_survey_id"
  end
  ...
  add_foreign_key "answes", "questions"
  add_foreign_key "answes", "surveys"
